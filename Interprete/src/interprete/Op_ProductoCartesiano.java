 ...
 * @author M Express
 */
public class Op_ProductoCartesiano extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("PRODUCTO CARTESIANO");
    ...
    private void butComprobarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_butComprobarMouseClicked
        ...
        String Res1 = "σ * "+ "(" +Tabla + " X " + Tabla2 + ")";
        String Res2 = "Select * from " + Tabla+","+Tabla2;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Op_ProductoCartesiano.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Op_ProductoCartesiano().setVisible(true);
            }
        });
    }
