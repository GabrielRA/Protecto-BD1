 ...
 * @author M Express
 */
public class Op_Join extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Op_Join.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
