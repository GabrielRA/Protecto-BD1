 ...
 * @author M Express
 */
public class Op_NaturalJoin extends javax.swing.JFrame {

    /**
     * Creates new form Operaciones
     */
    public Op_NaturalJoin() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Op_NaturalJoin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Op_NaturalJoin().setVisible(true);
            }
        });
    }
